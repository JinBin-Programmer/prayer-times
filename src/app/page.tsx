...
export default async function HomePage() {
  ...
  return (
    <div>
      {/* Mosque hero section — title + prayer display over mosque background */}
      <div className="mosque-hero-bg">
        <div className="max-w-2xl mx-auto px-4 pt-8 pb-6">
          <div className="animate-in text-center mb-5">
            ...
            <p className="text-indigo-200 text-sm mt-1.5">
              Waktu solat harian untuk Malaysia &middot; Daily Prayer Times
            </p>
          </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        {/* First ad — moved below prayer display */}
